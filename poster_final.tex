...
\begin{columns}
    ...
    How to find the distribution of $U$? In \cite{bailey2023critical} the authors were able to compute its distribution by hand for $d = 2, 3, 4$. In our research we found an inductive way to compute the distribution of $U(d,p,\lambda)$ for higher $d$'s (summarized using Figure 4).
